...
type QueryResolver interface {
	KycApplicants(ctx context.Context) ([]*string, error)
}
...
func (ec *executionContext) _Query(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "kycApplicants":
			out.Values[i] = ec._Query_kycApplicants(ctx, field)
		case "__type":
...
func (ec *executionContext) _Query_kycApplicants(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	ctx = graphql.WithResolverContext(ctx, &graphql.ResolverContext{
		Object: "Query",
		Args:   nil,
		Field:  field,
	...
	return graphql.Defer(func() (ret graphql.Marshaler) {
		...
		resTmp := ec.FieldMiddleware(ctx, func(ctx context.Context) (interface{}, error) {
			return ec.resolvers.Query().KycApplicants(ctx)
		})
		if resTmp == nil {
			return graphql.Null
		}
