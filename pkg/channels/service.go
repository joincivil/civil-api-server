...
type StripeConnector interface {
	...
	IsApplePayEnabled(stripeAccountID string) (bool, error)
...
// EnableStripeApplePay activates Apple Pay on the configured domains
func (s *Service) EnableStripeApplePay(channelID string) ([]string, error) {
...
func (s *Service) StripeApplyPayEnabled(channelID string) (bool, error) {
	...
	return s.stripeConnector.IsApplePayEnabled(stripeAccountID)
}
